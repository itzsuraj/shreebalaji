...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.balajisphere.com/about',
    type: 'website',
  },
};
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm">All products meet international quality standards</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm">Cut out middlemen for better prices</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm">Technical guidance and product selection help</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-900 text-sm">Serving customers across India and internationally</p>
                </div>
              </div>
            </div>
          </div>
